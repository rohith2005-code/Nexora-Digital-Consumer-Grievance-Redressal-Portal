"""
Django settings for grievance_core project.
...
SECRET_KEY = 'django-insecure-gqeck5wf^dajqmqu!ga4fzl1gq%&d&yabni73=*-ks49fun1ql'
...
# Media files (Evidence, Invoices, Photos)
MEDIA_URL = '/media/'
